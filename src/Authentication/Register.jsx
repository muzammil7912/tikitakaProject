...
const Register = () => {
    ...
    useEffect(() => {
      if(res.data) {
        if(res.data.status === "false") {
          ...
          setTokenSession(res.data.api_token);
  ...
  return (
    <section className="SignInPage  grid">
      ...
      <div className="SignInPage__right flex items-center px-10 py-5 ">
        <div className="SignInPage__right_ w-100 h-full">
          <Link
            to={`/${config.demo}login`}
            className="arrowArrow flex items-center "
          >
            <img src={require("../dist/webImages/arrow-left.png")} alt="" />
            <span>Back</span>
          </Link>
          <br />
          <div className="h3 m-0">Vendor Account </div>
          <div className="h4 m-0">Registration</div>
          <br />
          <Formik
