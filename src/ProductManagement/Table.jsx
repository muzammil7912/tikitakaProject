...
const vendor_name = createOptions(keyDaata, 'vendor_name');
  ...
  const columns = [
    ...
    },
    {
      ...
      filters: vendor_name,
      onFilter: (value, record) => String(record.vendor_name).includes(value),
      ellipsis: true,
    },
    {
      key: 'category_name',
      ...
      .then(willDelete => {
        if (willDelete) {
          ...
          .then((response) => {
            ...
            axios.get(`${config.apiEndPoint}dashboard/productForAdmin`)
            .then((response) => {
      ...
      />
                ...
                <div className='grid grid-cols-2 gap-2'>
                    ...
                    <div className='venderview'>
                      <b>Vendor Name</b>
                      <br />
                      <span>{openRowData?.vendor_name}</span>
                    </div>
